...
void runData(bool mc = 0) {
  ...
  //inpaths = "/home/tdoan/samples/data/2017/SingleEle_2017B_PromptReco_v1/ggtree_data_*.root";
  ...
  //inpaths = "/home/tdoan/samples/data/2017/SingleMuon_Run2017B_PromptReco_v1/ggtree_data_*.root";
  //inpaths = "/home/tdoan/samples/data/2017/SingleMuon_Run2017B_PromptReco_v2_v3/ggtree_data_*.root";
  //inpaths = "/home/tdoan/samples/data/2017/SingleMuon_Run2017C_PromptReco_v1/ggtree_data_*.root";
  //inpaths = "/home/tdoan/samples/data/2017/SingleMuon_Run2017C_PromptReco_v2/ggtree_data_*.root";
  //inpaths = "/home/tdoan/samples/data/2017/SingleEle_2017D_PromptReco_v1_DCSJSON/ggtree_data_*.root"; 
  //inpaths = "/home/tdoan/samples/data/2017/SingleEle_2017D_PromptReco_v1_DCSJSON_929/ggtree_data_*.root";
  ...
  //---------muon dataset----------//
  //inpaths = "/data1/ggNtuples/V929/SingleMuon_Run2017D_PromptReco_v1_Nov24/ggtree_data_*.root";
  inpaths = "/data1/ggNtuples/V929/SingleMuon_Run2017E_PromptReco_v1_Nov24/ggtree_data_*.root";
  //inpaths = "/data1/ggNtuples/V929/SingleMuon_Run2017F_PromptReco_v1_Nov24/ggtree_data_*.root";

  cout << "Process sample: " << inpaths << endl;
  anaTnP(inpaths, "out.root",  mc);
}
